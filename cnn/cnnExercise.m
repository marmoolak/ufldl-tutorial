...
% optTheta =  zeros(2*hiddenSize*visibleSize+hiddenSize+visibleSize, 1); % 154192 x 1
% ZCAWhite =  zeros(visibleSize, visibleSize); % 192 x 192
% meanPatch = zeros(visibleSize, 1);  % 192 x 1
...
%% THIS BLOCK CAN BE COMMENTED OUT, and instead LOADS CONVOLVED FEATURES FROM A FILE
%
...
% commented out the long convolve and pooling of features, and load from last time
